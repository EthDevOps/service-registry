...
namespace QuokkaServiceRegistry.Migrations
{
    ...
    [Migration("20250701111857_UpdateServiceToOneToOneRelationships")]
    partial class UpdateServiceToOneToOneRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuokkaServiceRegistry.Models.HostingInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QuokkaServiceRegistry.Models.OnpremiseHost", b =>
                {
                    ...
                    b.Property<int?>("HostingInformationId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("HostingInformationId");
            ...
            modelBuilder.Entity("QuokkaServiceRegistry.Models.CatalogService", b =>
                {
                    ...
                    b.HasOne("QuokkaServiceRegistry.Models.HostingInformation", "Hosting")
                        .WithOne()
                        .HasForeignKey("QuokkaServiceRegistry.Models.CatalogService", "HostingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuokkaServiceRegistry.Models.CatalogVendor", b =>
                {
                    b.HasOne("QuokkaServiceRegistry.Models.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("QuokkaServiceRegistry.Models.OnpremiseHost", b =>
                {
                    ...
                    b.HasOne("QuokkaServiceRegistry.Models.HostingInformation", null)
                        .WithMany("OnpremisHosts")
                        .HasForeignKey("HostingInformationId");
